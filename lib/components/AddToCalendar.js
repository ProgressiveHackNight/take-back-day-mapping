...
var AddToCalendar = function AddToCalendar(props) {
  return _react2.default.createElement(
    "button",
    { style: _extends({}, _buttons.ctaButton, { outline: 'none', padding: '8px' }), className: "reminder-button" },
    _react2.default.createElement(_reactAddToCalendar2.default, { event: _extends({}, _event.event, { location: props.location || '' }) })
  );
};
