...
var TextReminder = function (_Component) {
  ...
  function TextReminder(props) {
    ...
    _this.handleChange = function (event) {
      ...
      var numberWithoutFormatting = inputValue.replace(/\D/g, "");

      if (_this.validateInput(numberWithoutFormatting)) {
        _this.setState({
          error: null,
  ...
  _createClass(TextReminder, [{
    ...
    value: function render() {
      var inputSectionStyle = this.props.visible && !this.props.isCompleted ? _modalStyles.modalReminderWrapper : { display: "none" };
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(_reactInputMask2.default, { mask: "(999) 999 - 9999", maskChar: " ", autoFocus: true })
          ),
          _react2.default.createElement(
            "button",
            { style: _buttons.ctaButton, onClick: this.handleSubmit },
            "submit"
          )
        ),
