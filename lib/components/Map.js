    ...
    value: function render() {
      ...
      var generateMarkers = function generateMarkers(mapLocations) {
        return mapLocations.map(function (location, index) {
          return location.lat && location.lon && _react2.default.createElement(_MapMarkerContainer2.default, {
            key: location.id,
            location: location,
            lat: location.lat,
            lng: location.lon,
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          _googleMapReact2.default,
          {
            ...
            bootstrapURLKeys: {
              key: process.env.REACT_APP_MAP_KEY || "AIzaSyDxJRIxEgWCGd2u-a_ZaucTTO3_DzHHL4U"
            },
