...
var TextReminder = function (_Component) {
  ...
  _createClass(TextReminder, [{
    ...
    value: function render() {
      var stlye = this.props.visible && !this.props.isCompleted ? _modalStyles.TextReminderWrapper : { display: 'none' };
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'button',
            { style: _modalStyles.modalButtonStyle, onClick: this.handleClick },
            'submit'
          )
        ),
